...
const SECTOR_META = {
  centro:   { name: '9º BPM - Centro',                color: '#00d4ff' },
  norte:    { name: '11º BPM - Zona Norte',           color: '#00ff88' },
  leste:    { name: '19º BPM - Zona Leste',           color: '#ffb020' },
  ipiranga: { name: '1º BPM - Zona Sul',              color: '#ff6ec7' },
  moinhos:  { name: '20º BPM - Zona Nordeste',        color: '#a78bfa' },
  menino:   { name: '21º BPM - Extremo Sul',          color: '#ff3b3b' },
};
